...
function loadFeedPage() {
    ...
    <img class="absolute top-0 left-0 w-full pointer-events-none" src="public/assets/hill1.png" id="hill1">
    <img class="absolute top-0 left-0 w-full pointer-events-none" src="public/assets/hill2.png" id="hill2">
    <img class="absolute top-0 left-0 w-full pointer-events-none" src="public/assets/hill3.png" id="hill3">
    <img class="absolute top-0 left-0 w-full pointer-events-none" src="public/assets/hill4.png" id="hill4">
    <img class="absolute top-0 left-0 w-full pointer-events-none" src="public/assets/hill5.png" id="hill5">
    <img class="absolute top-0 left-0 w-full pointer-events-none" src="public/assets/tree.png" id="tree">
    <h2 id="text" class="absolute text-white text-9xl drop-shadow font-anta">GameVerse</h2>
    <img class="absolute top-0 left-0 w-full pointer-events-none" src="public/assets/leaf.png" id="leaf">
    <img class="absolute top-0 left-0 w-full pointer-events-none" src="public/assets/plant.png" id="plant">
</section>
...
<div class="w-2.4 mx-auto my-20"></div>
  <div class="border-2 border-bordergrey w-2/4 mx-auto flex items-center px-3 py-2 shadow-md rounded-lg bg-green-500 dark:bg-postbackground">
    ...
    <div class="flex flex-col w-full  p-4 mb-4">
      ...
      <!-- Post Image -->
      <img src="public/assets/post1.jpg" alt="Post Image" class="w-full rounded-lg mb-4">
      <!-- Post Actions -->
...
function loadGroupsPage() {
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-postbackground border-2 border-bordergrey rounded-lg shadow-lg p-8">
              <div class="flex items-center mb-2">
                <img src="public/assets/profile.jpg" alt="Profile Picture" class="w-10 h-10 rounded-full mr-2">
